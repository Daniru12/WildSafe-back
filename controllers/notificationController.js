...
exports.createNotification = async (userId, title, message, type, priority, relatedIncident = null, metadata = null) => {
  try {
...
exports.notifyByRole = async (role, title, message, type, priority, relatedIncident = null) => {
  try {
